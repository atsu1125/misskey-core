	...
	<div class="main">
		...
		<div class="contents">
			...
			<div v-if="!root" class="powered-by">
				<b><MkA to="/">{{ host }}</MkA></b>
				<small>Powered by <a href="https://github.com/atsu1125/misskey-core" target="_blank">Misskey</a></small>
			</div>
		</div>
	</div>
